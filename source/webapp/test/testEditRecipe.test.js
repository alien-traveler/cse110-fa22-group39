describe("Testing for repeated recipe names", () => {
    ...
    it("test the review process after editing recipe", async () => {
        ...
        expect(
          ...
          await page.goto(
            "https://alien-traveler.github.io/cse110-fa22-group39/webapp/savedRecipes/savedRecipes.html"
            );
            await page.waitForXPath('//*[@id="remove0"]');
            await (await page.$x('//*[@id="remove0"]'))[0].click();
    });
});